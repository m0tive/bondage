...
class TestGenerator < Test::Unit::TestCase
  ...
  >(\"test1\")", fnGen.bind
    assert_equal "Reflect::detail::CallHelper<Reflect::detail::FunctionHelper<void(::Gen::GenCls::*)(int, float, double)>, &::Gen::GenCls::test1, bondage::FunctionCaller>", fnGen.typedefs["Gen_GenCls_test1_overload0_t"]
  ...
  >", fnGen.typedefs["GenCls_test2_overload"]
    assert_equal "Reflect::detail::CallHelper<Reflect::detail::FunctionHelper<void(*)(::Gen::GenCls &, int)>, &Gen_GenCls_test2_overload0, bondage::FunctionCaller>", fnGen.typedefs["Gen_GenCls_test2_overload0_t"]
    assert_equal "Reflect::FunctionArgCountSelectorBlock<2,
    Gen_GenCls_test2_overload0_t
    >", fnGen.typedefs["GenCls_test2_overload_2"] 
  assert_equal "Reflect::detail::CallHelper<Reflect::detail::FunctionHelper<void(*)(::Gen::GenCls &, int, float)>, &Gen_GenCls_test2_overload1, bondage::FunctionCaller>", fnGen.typedefs["Gen_GenCls_test2_overload1_t"]
  assert_equal "Reflect::FunctionArgCountSelectorBlock<3,
    Gen_GenCls_test2_overload1_t
    >", fnGen.typedefs["GenCls_test2_overload_3"] 
  assert_equal "Reflect::detail::CallHelper<Reflect::detail::FunctionHelper<void(::Gen::GenCls::*)(int, float, double)>, &::Gen::GenCls::test2, bondage::FunctionCaller>", fnGen.typedefs["Gen_GenCls_test2_overload2_t"]
 ...
 "void Gen_GenCls_test2_overload1(::Gen::GenCls & inputArg0, int inputArg1, float inputArg2)\n{\n  inputArg0.test2(std::forward<int>(inputArg1), std::forward<float>(inputArg2));\n}"], fnGen.extraFunctions
    ...
    assert_equal "Reflect::detail::CallHelper<Reflect::detail::FunctionHelper<void(*)(bool)>, &::Gen::GenCls::test3, Reflect::MethodInjectorBuilder<bondage::FunctionCaller>>", fnGen.typedefs["Gen_GenCls_test3_overload0_t"]
    assert_equal "bondage::FunctionBuilder::build<
  ...
  >(\"test3\")", fnGen.bind
    ...
    assert_equal "Reflect::detail::CallHelper<Reflect::detail::FunctionHelper<int(*)(bool, int)>, &Gen_GenCls_test3_overload0, Reflect::MethodInjectorBuilder<bondage::FunctionCaller>>", fnGen.typedefs["Gen_GenCls_test3_overload0_t"]
    assert_equal "Reflect::FunctionArgCountSelectorBlock<2,
    Gen_GenCls_test3_overload0_t
    >", fnGen.typedefs["GenCls_test3_overload_2"]
    assert_equal "Reflect::detail::CallHelper<Reflect::detail::FunctionHelper<int(*)(bool, int, bool)>, &::Gen::GenCls::test3, Reflect::MethodInjectorBuilder<bondage::FunctionCaller>>", fnGen.typedefs["Gen_GenCls_test3_overload1_t"]
    assert_equal "Reflect::FunctionArgCountSelectorBlock<3,
  ...
  >", fnGen.typedefs["GenCls_test3_overload"]
    ...
    assert_equal "Reflect::detail::CallHelper<Reflect::detail::FunctionHelper<int(*)(bool, int)>, &Gen_GenCls_test3_overload1, Reflect::MethodInjectorBuilder<bondage::FunctionCaller>>", fnGen.typedefs["Gen_GenCls_test3_overload1_t"]
    assert_equal "Reflect::FunctionArgCountSelectorBlock<2,
    Gen_GenCls_test3_overload1_t
    >", fnGen.typedefs["GenCls_test3_overload_2"]
    assert_equal "Reflect::detail::CallHelper<Reflect::detail::FunctionHelper<int(*)(bool, int, bool)>, &::Gen::GenCls::test3, Reflect::MethodInjectorBuilder<bondage::FunctionCaller>>", fnGen.typedefs["Gen_GenCls_test3_overload2_t"]
    assert_equal "Reflect::FunctionArgCountSelectorBlock<3,
  ...
  >", fnGen.typedefs["GenCls_test3_overload"]
    ...
    assert_equal "Reflect::detail::CallHelper<Reflect::detail::FunctionHelper<int(*)(bool, bool)>, &::Gen::test4, Reflect::MethodInjectorBuilder<bondage::FunctionCaller>>", fnGen.typedefs["Gen_test4_overload0_t"]
    assert_equal "bondage::FunctionBuilder::build<
  ...
  >", fnGen.typedefs["GenCls_test5_overload"]
    ...
    assert_equal "Reflect::detail::CallHelper<Reflect::detail::FunctionHelper<int(*)(bool, bool)>, &Gen_test5_overload0, Reflect::MethodInjectorBuilder<bondage::FunctionCaller>>", fnGen.typedefs["Gen_test5_overload0_t"]
    assert_equal "Reflect::detail::CallHelper<Reflect::detail::FunctionHelper<int(*)(bool, bool, float)>, &::Gen::test5, Reflect::MethodInjectorBuilder<bondage::FunctionCaller>>", fnGen.typedefs["Gen_test5_overload1_t"]
  ...
  def test_functionGeneratorParamDirection
    ...
    assert_equal "Reflect::detail::CallHelper<Reflect::detail::FunctionHelper<int(*)(::Gen::MultipleReturnGen &)>, &Gen_MultipleReturnGen_test_overload0, bondage::FunctionCaller>", fnGen.typedefs["Gen_MultipleReturnGen_test_overload0_t"]
    assert_equal "Reflect::FunctionArgCountSelectorBlock<2,
    Gen_MultipleReturnGen_test_overload0_t
    >", fnGen.typedefs["MultipleReturnGen_test_overload_2"]
    assert_equal "Reflect::detail::CallHelper<Reflect::detail::FunctionHelper<int(*)(::Gen::MultipleReturnGen &, Gen::MultipleReturnGen *)>, &Gen_MultipleReturnGen_test_overload1, bondage::FunctionCaller>", fnGen.typedefs["Gen_MultipleReturnGen_test_overload1_t"]
    assert_equal "Reflect::FunctionArgCountSelectorBlock<3,
    Gen_MultipleReturnGen_test_overload1_t
    >", fnGen.typedefs["MultipleReturnGen_test_overload_3"]
    assert_equal "Reflect::detail::CallHelper<Reflect::detail::FunctionHelper<std::tuple< double, Gen::MultipleReturnGen, const int >(*)(::Gen::MultipleReturnGen &, const int &, Gen::MultipleReturnGen &)>, &Gen_MultipleReturnGen_test_overload2, bondage::FunctionCaller>", fnGen.typedefs["Gen_MultipleReturnGen_test_overload2_t"]
    assert_equal "Reflect::FunctionArgCountSelectorBlock<4,
...
"std::tuple< double, Gen::MultipleReturnGen, const int > Gen_MultipleReturnGen_test_overload2(::Gen::MultipleReturnGen & inputArg0, const int & inputArg1, Gen::MultipleReturnGen & inputArg2)
{
  ...
  def test_functionGeneratorConstructors
    ...
    assert_equal "Reflect::detail::CallHelper<Reflect::detail::FunctionHelper<::Gen::CtorGen *(*)()>, &Gen_CtorGen_CtorGen_overload0, Reflect::MethodInjectorBuilder<bondage::FunctionCaller>>", fnGen.typedefs["Gen_CtorGen_CtorGen_overload0_t"]
    assert_equal "Reflect::FunctionArgCountSelectorBlock<1,
    Gen_CtorGen_CtorGen_overload0_t
    >", fnGen.typedefs["CtorGen_CtorGen_overload_1"]
    assert_equal "Reflect::detail::CallHelper<Reflect::detail::FunctionHelper<std::tuple< ::Gen::CtorGen *, int >(*)()>, &Gen_CtorGen_CtorGen_overload1, Reflect::MethodInjectorBuilder<bondage::FunctionCaller>>", fnGen.typedefs["Gen_CtorGen_CtorGen_overload1_t"]
    assert_equal "Reflect::FunctionArgCountSelectorBlock<2,
