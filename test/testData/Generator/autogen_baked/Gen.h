...
BONDAGE_EXPOSED_CLASS_DERIVED_MANAGED(GEN_EXPORT, ::Gen::InheritTest, ::Gen::GenCls, ::Gen::GenCls)
BONDAGE_EXPOSED_CLASS_DERIVED_MANAGED(GEN_EXPORT, ::Gen::InheritTest2, ::Gen::InheritTest, ::Gen::GenCls)
